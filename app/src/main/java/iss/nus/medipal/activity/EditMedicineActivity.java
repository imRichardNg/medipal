...
public class EditMedicineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //medicine = getIntent().getExtras().getParcelable("medicine");
        medicine = getIntent().getExtras().getParcelable("medicine");
        //ice = getIntent().getExtras().getParcelable("iceContact");
        System.out.println("editMedicineActy: " + medicine.getMedicineId());
        ...
        spnCategoryType = (Spinner) findViewById(R.id.spn_categoryType);
        spnReminderType = (Spinner) findViewById(R.id.spn_reminderType);
        etMedicine.setText(medicine.getMedicineName().toString());
        etMedicineDes.setText(medicine.getMedicineDescription().toString());
        etQuantity.setText(String.valueOf(medicine.getQuantity()));
        etDosage.setText(String.valueOf(medicine.getDosage()));
        etConsumedQuantity.setText(String.valueOf(medicine.getConsumedQuantity()));
        etThershold.setText(String.valueOf(medicine.getThereshold()));
        etExpireFactor.setText(String.valueOf(medicine.getExpireFactor()));
        ckIsRemind.setChecked(medicine.isRemind());
        etIssuedDate.setText(dateformat.format(medicine.getIssuedDate()));
        ...
        //spnCategoryType.setAdapter();
        //spnCategoryType.setSelection(medicine.getCategoryID());
        //spnReminderType.setSelection(medicine.getReminderID());

        btnEditMedicine = (Button) findViewById(R.id.btn_editMedicine);
        btnEditMedicine.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isValid()) {
                    ...
                    App.medipal.editMedicineList(medicine.getMedicineId(), medicineName, medicineDesc, isReminder, categoryID, reminderID, quantity, dosage, consumedQuantity, thershold, expireFactor, dt, getApplicationContext());
                    finish();

                    //check the condition.
                    Intent intent = new Intent(EditMedicineActivity.this, ManageMedicineActivity.class);
                    startActivity(intent);
                    Toast toast = Toast.makeText(EditMedicineActivity.this, "Medicine Info Updated.", Toast.LENGTH_LONG);
                    toast.show();
                }
            }
        });

        //Delete Medicine & Consumption.
        btnDeleteMedicine = (Button) findViewById(R.id.btn_deleteMedicine);
        btnDeleteMedicine.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                App.medipal.deleteMedicine(medicine.getMedicineId(), getApplicationContext());
                finish();

                //check the condition.
                Intent intent = new Intent(EditMedicineActivity.this, ManageMedicineActivity.class);
                startActivity(intent);
                Toast toast = Toast.makeText(EditMedicineActivity.this, "Medicine Deleted OK.", Toast.LENGTH_LONG);
                toast.show();
            }
        });
    }
