...
public class EditReminderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentCalendar.setTime(reminder.getStartDate());
        ...
        btnEditReminder = (Button) findViewById(R.id.btn_editReminder);
        btnDeleteReminder = (Button) findViewById(R.id.btn_deleteReminder);
        ...
        etStartDate.setOnClickListener(v -> {
            ...
            DatePickerDialog datePickerDialog =
                    new DatePickerDialog(EditReminderActivity.this, onDateSetListener,
        ...
        etStartTime.setOnClickListener((v -> {
            ...
            TimePickerDialog timePickerDialog =
                    new TimePickerDialog(EditReminderActivity.this, onTimeSetListener,
                            currentCalendar.get(Calendar.HOUR_OF_DAY), currentCalendar.get(Calendar.MINUTE), false);
            timePickerDialog.show();
        }));

        etFrequency.setText(String.valueOf(reminder.getFrequency()));
        etInterval.setText(String.valueOf(reminder.getInterval()));
        ...
        btnEditReminder.setOnClickListener(v -> {
            if (isValidReminder()) {
                ...
                App.medipal.editReminder(reminder.getId(), selectedDate.getTime(), frequencyInt, intervalInt, getApplicationContext());
                finish();
            }
        });

        btnDeleteReminder.setOnClickListener(v -> {
            App.medipal.deleteReminder(reminder.getId(), getApplicationContext());
            finish();
        });
    }
